...
const styles = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .qa-nav-btn:hover { background: rgba(255,255,255,0.1); color: #FF5C1A; }
  .qa-nav-btn.active { color: #FF5C1A; background: rgba(255,255,255,0.1); }
  ...
  .qa-search-wrap {
    ...
    box-shadow: 0 6px 32px rgba(255,92,26,0.09), 0 2px 10px rgba(0,0,0,0.05);
    margin-bottom: 22px;
  ...
  .qa-search-wrap.focused {
    border-color: #FF5C1A;
    box-shadow: 0 10px 44px rgba(255,92,26,0.14), 0 0 0 3px rgba(255,92,26,0.07);
  }
  ...
  .qa-textarea::placeholder { color: rgba(255,255,255,0.4); }
  ...
  .qa-icon-btn:hover { background: rgba(255,255,255,0.1); color: #FF5C1A; border-color: rgba(255,92,26,0.25); }
  .qa-icon-btn svg { width: 15px; height: 15px; }

  .qa-hint { font-size: 12px; color: rgba(255,255,255,0.4); }
  ...
  .qa-chip:hover {
    ...
    box-shadow: 0 4px 16px rgba(255,92,26,0.11);
  }
  ...
  .qa-card:hover {
    ...
    box-shadow: 0 14px 44px rgba(255,92,26,0.1), 0 2px 8px rgba(0,0,0,0.04);
  }
  ...
  .qa-recent-item:hover { border-color: rgba(255,92,26,0.5); color: #f8f8f8; background: rgba(255,255,255,0.1); }
