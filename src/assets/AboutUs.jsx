    ...
    <div style={{ fontFamily: "'Sora', 'Segoe UI', sans-serif", background: "#F4F6FA", minHeight: "calc(100vh - 120px)", padding: "40px 20px" }}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <header style={{ textAlign: "center", marginBottom: 60 }}>
          <h1 style={{ fontSize: "clamp(2rem, 5vw, 3.5rem)", fontWeight: 800, color: "#1a1a1a", marginBottom: 12, letterSpacing: "-0.02em" }}>
            The <span style={{ color: "#FF6B00" }}>QuickArt</span> Team
          </h1>
          <p style={{ fontSize: "1.1rem", color: "#555", maxWidth: 600, margin: "0 auto", lineHeight: 1.6 }}>
        ...
        <section style={{ marginBottom: 60 }}>
          <h2 style={{ textAlign: 'center', fontSize: '2rem', fontWeight: 800, color: '#1a1a1a', marginBottom: 40 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 24 }}>
            <div style={{ textAlign: 'center', padding: '20px' }}>
              <div style={{ display: 'inline-flex', padding: '18px', background: '#fff', borderRadius: '50%', marginBottom: '16px', boxShadow: '0 8px 30px rgba(0,0,0,0.07)' }}>
                <Cpu size={32} color="#FF6B00" />
              </div>
              <h3 style={{ fontSize: 18, fontWeight: 700, color: '#1a1a1a', marginBottom: 8 }}>AI-Powered Shopping</h3>
            ...
            <div style={{ textAlign: 'center', padding: '20px' }}>
              <div style={{ display: 'inline-flex', padding: '18px', background: '#fff', borderRadius: '50%', marginBottom: '16px', boxShadow: '0 8px 30px rgba(0,0,0,0.07)' }}>
                <View size={32} color="#FF6B00" />
              </div>
              <h3 style={{ fontSize: 18, fontWeight: 700, color: '#1a1a1a', marginBottom: 8 }}>Immersive 3D & AR</h3>
              <p style={{ fontSize: 14, color: '#555', lineHeight: 1.6 }}>
            ...
            <div style={{ textAlign: 'center', padding: '20px' }}>
              ...
              <h3 style={{ fontSize: 18, fontWeight: 700, color: '#1a1a1a', marginBottom: 8 }}>Fast & Reliable</h3>
              <p style={{ fontSize: 14, color: '#555', lineHeight: 1.6 }}>
        ...
        <div>
          <h2 style={{ textAlign: 'center', fontSize: '2rem', fontWeight: 800, color: '#1a1a1a', marginBottom: 40 }}>Meet the Innovators</h2>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))", gap: 32 }}>
            {teamMembers.map((member, index) => (
              <div key={index} className="team-card">
                <div className="avatar">{member.avatar}</div>
                <h3 style={{ fontSize: 18, fontWeight: 700, color: "#1a1a1a", margin: "0 0 4px" }}>{member.name}</h3>
                <p style={{ fontSize: 14, color: "#FF6B00", fontWeight: 600, margin: 0 }}>{member.role}</p>
                <p style={{ fontSize: 12, color: "#888", marginTop: 8, background: "#F4F6FA", padding: "4px 8px", borderRadius: 6, display: "inline-block" }}>
                  ID: {member.id}
                </p>
              </div>
            ))}
